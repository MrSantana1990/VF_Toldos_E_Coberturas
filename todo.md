...
- [x] Coleta de dados de contato do cliente
- [x] Cálculo automático de área (m²)
...
- [x] Página de agenda de agendamentos
- [x] Página de controle financeiro (entradas/saídas)
- [ ] Relatórios simples
